module.exports = function(ctx) {
  ...
  console.register('upload', 'Upload static files to a remote server.', {
    desc: 'Compress a folder as zip and upload to a remote server.',
    options: [
      {name: '-d, --dir', desc: 'Compress directory path'}
    ]
  }, require('./upload'));

  console.register('list', 'Listing static html files as index.', {
    desc: 'Read publish folder to list static html files.'
  }, require('./list'));
