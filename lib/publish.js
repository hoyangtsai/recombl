...
if (Array.isArray(baseConfig.extLoaders)) {
  for (let i in baseConfig.extLoaders) {
    webpackOutputHtmlConfig.module.rules.push(baseConfig.extLoaders[i]);
  }
}
...
if (Array.isArray(baseConfig.extLoaders)) {
  for (let i in baseConfig.extLoaders) {
    webpackOutputConfig.module.rules.push(baseConfig.extLoaders[i]);
  }
}
...
webpackPromise(webpackOutputHtmlConfig)
  ...
  .then((htmlEnd) => {
    ...
    if (!Array.isArray(baseConfig.entry)) {
      ...
      if (Array.isArray(baseConfig.extLoaders)) {
        for (let i in baseConfig.extLoaders) {
          webpackOutputCssConfig.module.rules.push(baseConfig.extLoaders[i]);
        }
      }
